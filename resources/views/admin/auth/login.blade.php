...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email"
                                            value="{{ old(key: 'email') }}" placeholder="info@gmail.com"
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="absolute right-0 top-0 -z-1 w-full max-w-[250px] xl:max-w-[450px]">
                        <img src="../tailadmin/build/src/images/shape/grid-01.svg" alt="grid" />
                    </div>
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="index.html" class="block mb-4">
                            <img src="../tailadmin/build/src/images/logo/auth-logo.svg" alt="Logo" />
                        </a>
    ...
    <!-- ===== Page Wrapper End ===== -->
    <script defer src="../tailadmin/build/bundle.js"></script>
</body>
